    ...
    <div className="p-[8px] flex items-center justify-around sticky top-0 z-50 bg-[#0c2851] shadow">
      ...
      <div className="flex lg:flex-col items-center lg:gap-3">
        <div className="flex items-center justify-around gap-4">
          ...
          {/* Mobile Drawer */}
          <div
            className={`fixed z-50 top-0 right-0 h-screen pb-12 overflow-auto lg:hidden w-8/12 bg-gradient-to-b from-[#0B254C] via-[#348fd1] to-[#072043]  shadow-lg transition-transform duration-500 ease-in-out transform ${
