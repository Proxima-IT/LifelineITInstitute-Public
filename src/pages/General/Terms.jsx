...
const Terms = () => {
  return (
    <div>
      <div className="min-h-screen my-4 bg-white text-gray-800 px-4 md:px-12 py-10 max-w-4xl mx-auto font-sans leading-relaxed">
        {/* Title */}
        ...
        {/* Intro Paragraph */}
        <p className="mb-6">
          Welcome to Lifeline IT Training Institute (“we”, “our”, “us”). These
          Terms & Conditions (“Terms”) outline the rules and regulations for
          using our website, applications, LMS, and physical training services.
          By accessing or using any of our services, you agree to comply with
          these Terms.
        </p>
        ...
        <section className="mb-6  text-left">
          ...
          <ul className="list-disc pl-8 space-y-1">
            ...
            <li>
              Access is valid for the duration mentioned during enrollment.
            </li>
            <li>
              Content is for personal use only and cannot be copied or shared.
            </li>
          </ul>
        </section>
        ...
        <section className="mb-6  text-left">
          ...
          <ul className="list-disc pl-8 space-y-1">
            ...
            <li>
              Registration fees and processing charges are usually
              non-refundable.
            </li>
          </ul>
        </section>
        ...
        <section className="mb-6  text-left">
          ...
          <ul className="list-disc pl-8 space-y-1">
            ...
            <li>
              Offensive, illegal, or disruptive behavior will not be tolerated.
            </li>
            <li>
              Academic dishonesty (like plagiarism or cheating) may result in
              dismissal.
            </li>
          </ul>
        </section>
        ...
        <section className="mb-6  text-left">
          ...
          <ul className="list-disc pl-8 space-y-1">
            <li>
              All materials (videos, notes, logos, etc.) belong to Lifeline IT.
            </li>
            <li>
              No user may reuse or distribute training materials without written
              permission.
            </li>
          </ul>
        </section>
        ...
        <section className="mb-6  text-left">
          ...
          <ul className="list-disc pl-8 space-y-1">
            ...
            <li>
              Maintenance or unforeseen events may occasionally limit
              availability.
            </li>
            <li>
              Lifeline IT reserves the right to modify or discontinue services
              at any time.
            </li>
          </ul>
        </section>
        ...
        <section className="mb-6  text-left">
          ...
          <ul className="list-disc pl-8 space-y-1">
            ...
            <li>
              You may cancel your registration by contacting us officially.
            </li>
          </ul>
        </section>
        ...
        <section className="mb-6  text-left">
          ...
          <ul className="list-disc pl-8 space-y-1">
            ...
            <li>
              Continued use of services indicates acceptance of the new terms.
            </li>
          </ul>
        </section>
        ...
        <p className="text-sm text-gray-600 mt-8 text-center">
          ✅ By enrolling or using any service, you agree to the above Terms &
          Conditions.
        </p>
      </div>
    </div>
